# 🏆 LegalEase AI - Google Cloud Gen AI Exchange Hackathon
...
**Hackathon**: Google Cloud Gen AI Exchange Hackathon by Hack2Skill
**Team**: Solo submission by Vineet Nag V
**Category**: AI-powered legal technology solution
